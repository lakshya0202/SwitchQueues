...
print("Simulation Results of RVI QLearning")
print()
...
def RelativeValueIterationQLearning(alpha, TRAIN_EPISODES, TEST_EPISODES):
    ...
    print("Average queue length epsilon-greedy Policy:", avg_reward, "with alpha:", alpha)
    return avg_reward
...
def RelativeValueIterationQLearning(alpha, TRAIN_EPISODES, TEST_EPISODES):
    ...
    print("Average queue length Random Policy:", avg_reward, "with alpha:", alpha)
    return avg_reward
...
def RelativeValueIterationQLearning(alpha, TRAIN_EPISODES, TEST_EPISODES):
    ...
    print("Average queue length MaxWeight:", avg_reward, "with alpha:", alpha)
    return avg_reward
...
def RelativeValueIterationQLearning(alpha, TRAIN_EPISODES, TEST_EPISODES, epsilon):
    ...
    print("Average queue length Epsilon MaxWeight+Random:", avg_reward, "with alpha:", alpha, "and epsilon:", epsilon)
    return avg_reward
